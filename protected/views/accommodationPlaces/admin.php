...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('accommodation-places-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Accommodation Places</h1>
...
<?php echo CHtml::link('New',array('/accommodationPlaces/create')); ?>
