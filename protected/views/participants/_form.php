...
?>
	...
	<div class="registrationBlock">
		<p class="title"><?php echo $m->translate('Participants', 'personal_data_title'); ?></p>
		<p class="note"><?php echo $m->translate('Participants', 'personal_data_note'); ?></p>
...
?>
	...
	<div class="registrationBlock">
		<p class="title"><?php echo $m->translate('Participants', 'report_title'); ?></p>
		<p class="note"><?php echo $m->translate('Participants', 'report_note_p1'); ?></p>
		<p class="note"><?php echo $m->translate('Participants', 'report_note_p2'); ?></p>
