...
function Menu(caller, options){
	...
	Menu.scheduleKillAllMenu = function(bOn) {
		if (Menu.hideAllTimer) {clearTimeout(Menu.hideAllTimer);Menu.hideAllTimer = 0;}
		if (bOn)
...
$.mouseIn = function(event, el) {
	var o = el.offset(), m={x: event.clientX + $(document).scrollLeft(), y: event.clientY + $(document).scrollTop()};
